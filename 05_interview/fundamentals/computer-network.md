...
layout: default
title: 计算机网络面试速查题库
description: TCP、UDP、HTTP、HTTPS、DNS 与 URL 请求链路高频面试问题速查
eyebrow: 八股文 / 计算机网络速查
permalink: /05_interview/fundamentals/computer-network/
---

# 计算机网络面试速查题库

> 本页用于学完后的复习与面试表达。第一次学习请从 [计算机网络系统课](../cs-core/computer-network/) 开始，先建立分层、路由、可靠传输和应用协议的完整模型。
