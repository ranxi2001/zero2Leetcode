...
> 使用建议：本页是复习题库，不是零基础教材。转码或非科班读者先完成 [计算机基础系统课](../cs-core/)，再用这些问题检查能否在 30 秒总结、2 分钟展开并承接追问。
...
前置教程：[操作系统系统课](../cs-core/operating-system/)
...
| 开销 | 通常更重，可能切换地址空间 | 通常更轻，共享地址空间；具体仍取决于实现与调度 |
...
前置教程：[计算机网络系统课](../cs-core/computer-network/)
