...
layout: default
title: 操作系统面试速查题库
description: 进程线程、调度同步、虚拟内存、文件系统与 I/O 高频问题速查
eyebrow: 八股文 / 操作系统速查
permalink: /05_interview/fundamentals/operating-system/
---

# 操作系统面试速查题库

> 本页用于学完后的复习与面试表达。第一次学习请从 [操作系统系统课](../cs-core/operating-system/) 开始，先理解内核状态、资源队列和完整执行路径。
